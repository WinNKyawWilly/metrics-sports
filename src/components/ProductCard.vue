...
<template>
    ...
    <div class="max-w-sm w-full bg-white rounded-lg shadow-md overflow-hidden m-2">
        <!-- Product Image -->
        <div class="cursor-pointer" @click="navigateToProduct(product)">
            ...
            <div class="p-4">
                ...
                <div v-if="product.discountPrice" class="flex items-center mt-4">
                    <span class="text-lg font-bold text-gray-900 mr-2 line-through">${{ product.price }}</span>
                    <span class="text-lg font-bold text-red-900">${{ product.discountPrice }}</span>
                </div>
