      ...
      <div class="flex gap-4 w-full max-w-4xl">
        ...
        <div class="flex flex-col gap-4 w-24">
          <div v-for="(image, index) in product.images" :key="index"
            ...
            :class="selectedImage === image ? 'border-black' : 'border-transparent'" @click="selectedImage = image">
      ...
      <div class="space-y-6">
        ...
        <div class="flex items-center space-x-4">
          <div class="flex items-center">
            <template v-for="i in 5" :key="i">
              <svg :class="i <= Math.floor(product.rating) ? 'text-yellow-400' : 'text-gray-300'"
        ...
        <div class="space-y-2">
          <div class="flex items-center space-x-4">
            ...
            <span v-if="product.discountPrice" class="px-2 py-1 bg-red-100 text-red-700 text-sm font-medium rounded">
        ...
        <!-- Add to Cart Button -->
        <button class="w-full bg-black text-white py-4 px-6 rounded-lg font-medium hover:bg-gray-800 transition-colors"
