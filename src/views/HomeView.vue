...
<template>
  <main>
    ...
    <NewReleases
      ...
      :products="homePageProducts?.newProducts"
    />
    <PromoAds
      image-position="left"
      image="/src/assets/images/sportwear3.png"
      image-alt="Summer Collection 2024"
      tag="New Collection"
      ...
      theme="light"
      @button-click="handleShopClick"
    />

    <FeaturedProduct
      v-if="homePageProducts?.featuredProducts"
      :products="homePageProducts?.featuredProducts"
    />

    <PromoAds
      image-position="right"
      image="/src/assets/images/sportwear5.png"
      image-alt="Limited Edition Sneakers"
      tag="Limited Edition"
